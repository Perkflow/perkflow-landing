...
const experienceDeals = [
    {
        ...
        image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?q=80&w=1000&auto=format&fit=crop", // Reusing placeholder, should probably change
        // Let's use a real balloon image
        image_real: "https://images.unsplash.com/photo-1507608616759-54f48f0af0ee?q=80&w=1000&auto=format&fit=crop",
        rating: 4.9,
        price: "180€",
        duration: "3 Hours",
    },
...
export default function ExperiencesPage() {
    // using Shop_Page for generic strings or fallback
            ...
            <div className="relative h-[600px] w-full">
                ...
                <Container className="relative z-10 h-full flex flex-col items-center justify-center text-center pt-20">
                    ...
                    <div className="w-full max-w-5xl">
                        ...
                        <div className="rounded-[4rem] p-[2px] bg-gradient-to-r from-[#FF9E5E] to-[#005C73] shadow-[0_20px_60px_-10px_rgba(0,0,0,0.3)]">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {experienceDeals.map((deal) => (
                            <div key={deal.id} className="bg-white rounded-[2rem] p-4 shadow-sm hover:shadow-xl transition-all duration-300 ring-1 ring-gray-100 group">
                                <div className="relative aspect-[1.4/1] rounded-[1.5rem] overflow-hidden mb-5">
                                    <Image
                                        src={deal.image_real || deal.image}
                                        alt={deal.name}
                                        fill
