...
import fullControlImg from "@/assets/images/optimized/full-control.webp";
...
export default function FullControl() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#003B4A] py-20 text-white">
      ...
      <div className="mx-auto flex max-w-7xl flex-col-reverse items-center justify-between gap-12 px-2 md:flex-row">
        <Image
          src={fullControlImg}
