...
const getSUPPORT = (t: (key: string) => string) => [
  {
    icon: clockIcon,
    title: t("Benefits.benefit3.card.card1.title"),
    description: t("Benefits.benefit3.card.card1.description"),
  },
  {
    icon: expertIcons,
    title: t("Benefits.benefit3.card.card2.title"),
    description: t("Benefits.benefit3.card.card2.description"),
  },
  {
    icon: flowIcon,
    title: t("Benefits.benefit3.card.card3.title"),
    description: t("Benefits.benefit3.card.card3.description"),
  },
];
