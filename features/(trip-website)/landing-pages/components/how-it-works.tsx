...
export default function HowItWorks() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#003B4A] py-32 text-white">
      ...
      <div
        className={`mx-auto ${locale === "fr" ? "max-w-5xl" : "max-w-2xl"} space-y-6 px-2 text-center`}
      >
        {/* Pill label */}
      ...
      <div className="mx-auto mt-12 grid max-w-7xl grid-cols-1 gap-8 px-2 md:grid-cols-3">
