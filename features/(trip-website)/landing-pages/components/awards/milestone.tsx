...
export default function Milestone() {
  ...
  return (
    ...
    >
      <div className="flex w-full max-w-7xl flex-col items-center gap-10 overflow-hidden rounded-lg md:flex-row">
        <div className="flex w-full flex-col justify-center gap-6 p-4 md:w-1/2 md:py-8">
          <div>
