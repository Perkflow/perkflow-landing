  ...
  return (
    <footer className="bg-[#005C73] py-16 text-white md:py-32">
      <Container className="px-2 sm:px-3 lg:px-4">
        <div className="grid grid-cols-1 justify-between gap-8 px-2 sm:grid-cols-2">
        ...
        <div className="mt-10 md:mt-24">
          <div className="flex-col items-end justify-between gap-4 px-2 pt-6 text-xs font-light text-white sm:flex-row md:text-sm">
