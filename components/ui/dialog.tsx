...
function DialogContent({
  ...
  const isWhite = className?.includes("white-xicon-dialog");
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background fixed top-[50%] left-[50%] z-50 grid w-full max-w-[90vw] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border p-6 shadow-lg duration-200",
          className,
        )}
        {...props}
      >
        ...
        >
          <XIcon className={isWhite ? "text-white" : "text-muted-foreground"} />
